...
#N1_file_path='/Users/esforsythe/Documents/Work/Bioinformatics/ERC_networks/Analysis/Orthofinder/Plant_cell/Results_Feb15/Phylogenetic_Hierarchical_Orthogroups/N1.tsv'
...
def make_seq_counts_df(N1_file_path, mapping_table_path):
    ...
    counts_array=np.empty((N1_file.shape[0], len(sp_names)))
    counts_array[:] = np.NaN
...
if __name__ == "__main__":
    make_seq_counts_df(N1_file_path, mapping_table_path)
    

#Make function for filtering dataset by criteria
def filter_gene_fams(N1_file, counts_df_rearrange, sp_names, para_value, rep_value):
